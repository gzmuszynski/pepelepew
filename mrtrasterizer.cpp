...
MRTRasterizer::MRTRasterizer(int projection, int projectionPieces)

{
    ...
    switch(projection)
    {
    case 0 : {mp = new CubicProjection(this, projectionPieces); break;}
    default: {mp = new MRTProjection(this, projectionPieces); break;}
    }
}
